...
export default function GroupsPanel({ groups, refresh }: { groups: Group[], refresh: () => void }) {
  const [newUstadz, setNewUstadz] = useState('');
  ...
  return (
    <div className="flex flex-col gap-6 h-full">
      <div className="flex items-center justify-between">
        ...
        <div className="text-sm text-slate-500 font-medium">Total: {groups.length} Kelompok Halaqoh</div>
      </div>
